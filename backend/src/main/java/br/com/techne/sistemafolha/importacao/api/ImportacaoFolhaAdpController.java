...
public class ImportacaoFolhaAdpController {
    ...
    public ResponseEntity<ImportacaoFolhaAdpResponseDTO> importarFolhaAdp(
        ...
        try {
            ...
            List<FolhaPagamentoDTO> folhasPagamento = importacaoFolhaAdpService.importarFolhaAdp(
            ...
            return ResponseEntity.badRequest()
                .body(ImportacaoFolhaAdpResponseDTO.error(
                    "Erro ao importar arquivo ADP: " + e.getMessage(), arquivo.getOriginalFilename()));
        }
    }
}
