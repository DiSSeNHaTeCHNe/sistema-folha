...
import br.com.techne.sistemafolha.service.FolhaTotalizacaoService;
...
public class FolhaPagamentoController {
    ...
    public ResponseEntity<List<FolhaTotaisFuncionarioDTO>> consultarTotaisPorFuncionario(
        ...
        logger.info("Usuário {} consultou totais de folha: {} funcionários no período {} a {}",
            authentication.getName(), totais.size(), dataInicio, dataFim);
