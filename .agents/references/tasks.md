...
Read `_docs/specs/features/[feature]/design.md` before creating tasks.

### 1.5. Load Test Coverage Matrix

Read `_docs/specs/TESTING.md` (if it exists) before creating tasks. The Test Coverage Matrix
...
## Template: `_docs/specs/features/[feature]/tasks.md`

```markdown
# [Feature] Tasks

**Design**: `_docs/specs/features/[feature]/design.md`
