...
Read `_docs/specs/STATE.md` — Handoff section for in-flight state, Decisions section to re-confirm active constraints — then propose the next step.

## Context Loading Strategy

**On-demand load (only what the current task needs):**

- `_docs/specs/STATE.md` — Decisions section (read at Design, re-read on resume); Handoff section (read on resume only)
...
Step 2: Project docs → README, docs/, inline comments, `_docs/specs/STATE.md` (Decisions)
