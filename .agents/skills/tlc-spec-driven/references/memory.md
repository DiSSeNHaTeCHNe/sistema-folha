...
- **Feature**: [feature name / _docs/specs path]
...
1. Locate the `## Handoff` section in `_docs/specs/STATE.md`.
...
1. Read `_docs/specs/STATE.md` — both sections.
...
- If `_docs/specs/STATE.md` does not exist, the first decision is `AD-001`.
